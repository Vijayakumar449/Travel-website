  ...
  const data = [
    {
      ...
      subtitle: "pay through our application and save thousands and get amaxing rewards",
    },
    {
      icon: service2,
      title: "Covid safe",
    ...
    },
    {
      ...
      subtitle: "Find the best hotels and place to visit near you in a singl click",
    },
  ];
  return (
    <Section id="services">
